...
OLLAMA_MODEL_NAME = os.getenv("OLLAMA_MODEL_NAME", "phi3:mini") # O mistral, gemma, ....... llama3

OLLAMA_INTENT_MODEL_NAME = os.getenv("OLLAMA_MODEL_NAME", "phi3:mini")

# --- Configurazione RAG ---
TOP_K_RESULTS = 5 # Numero di documenti da recuperare dal DB per il contesto
CHAT_HISTORY_LIMIT = 3 
MIN_TOTAL_CHAT_MESSAGES_FOR_HISTORY = 5 # per poter considerare l'history nel retrieval